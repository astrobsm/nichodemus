...
export const PERMISSION_CATALOGUE: { code: Permission; name: string; category: string }[] = [
  ...
  { code: PERMISSIONS.LETTER_VIEW, name: 'View official letters', category: 'Project' },
  { code: PERMISSIONS.LETTER_EDIT, name: 'Write official letters', category: 'Project' },
  { code: PERMISSIONS.PHOTO_VIEW, name: 'View clinical photographs', category: 'Clinical' },
  { code: PERMISSIONS.PHOTO_CAPTURE, name: 'Take clinical photographs', category: 'Clinical' },
  { code: PERMISSIONS.PHOTO_DELETE, name: 'Delete clinical photographs', category: 'Clinical' },
